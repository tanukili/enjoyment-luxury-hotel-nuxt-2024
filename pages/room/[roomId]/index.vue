        ...
        <div class="row">
          <div class="col-12 col-md-7 d-flex flex-column gap-6 gap-md-20">
            ...
            <section>
              ...
              >
                <template
                  v-for="(layout, index) in room.layoutInfo"
                  :key="index"
                >
          ...
          <div class="d-none d-md-block col-md-5">
            ...
            >
              ...
              <h5 v-priceformat class="mb-0 text-primary-100 fw-bold">
                {{ room.price }}
              </h5>
              <NuxtLink
      ...
      >
        <template v-if="bookingDate.date.end === null">
          <small class="text-neutral-80 fw-medium"
            ><span v-priceformat:full>{{ room.price }}</span> / 晚</small
          >
          <button
        ...
        <template v-else>
          <div class="d-flex flex-column gap-1">
            <small class="text-neutral-80 fw-medium"
              ><span v-priceformat:full>{{ room.price }}</span> /

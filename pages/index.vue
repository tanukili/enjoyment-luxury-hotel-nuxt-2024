    ...
    >
      ...
      >
        ...
        <div class="room-intro-content text-neutral-0">
          <h2 class="mb-2 mb-md-4 fw-bold">{{ pickupRoom.name }}</h2>
          <p class="mb-6 mb-md-10 fs-8 fs-md-7">
            {{ pickupRoom.description }}
          </p>
          <div class="mb-6 mb-md-10 fs-3 fw-bold"></div>
          <div v-priceformat class="mb-6 mb-md-10 fs-3 fw-bold">
            {{ pickupRoom.price }}
          </div>
          <NuxtLink
            :to="`/room/${pickupRoom._id}`"
          ...
          >
            <div class="card position-relative border-0 rounded-3">
              ...
              >
                ...
                >
                  <h5 class="card-title mb-0 fw-bold">{{ dish.title }}</h5>
                  <div
                    class="d-flex justify-content-between gap-4 text-neutral-40 fs-8 fs-md-7"
                  >
                    <span class="fw-bold">{{ dish.diningTime }}</span>
                  </div>
                </div>
